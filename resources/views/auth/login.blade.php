        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    ...
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="{{asset('g1.png')}}" class="image"> </div>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <form action="{{route('login')}}" method="POST">
                    ...
                    <div class="row mb-4 px-3">
                        <h1 class="mb-0 mr-4 mt-2 text-center">SIGN IN</h6>
                    </div>
                    ...
                    <div class="row mb-4 px-3"> <small class="font-weight-bold">Don't have an account? <a class ="text-danger" href="{{route('register')}}">Register</a> </div>
                </form>
                </div>
            </div>
        </div>
